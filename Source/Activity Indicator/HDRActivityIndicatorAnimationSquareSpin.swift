//
//  HDRActivityIndicatorAnimationSquareSpin.swift
//  HDRActivityIndicatorView
//

import UIKit

class HDRActivityIndicatorAnimationSquareSpin: HDRActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw square
        let square = HDRActivityIndicatorShape.rectangle.layerWith(size: size, color: color)
